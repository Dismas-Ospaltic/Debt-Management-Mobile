...
//    val currencyViewModel: CurrencyViewModel = getViewModel()
//    val isCurrencySet by currencyViewModel.isCurrencySet.collectAsState(initial = null)
//
////    if (isCurrencySet == null) {
////        // Optional: You can show a loading screen while checking currency
////        LoadingScreen()
////        return
////    }
//
//    val startDestination = if (isCurrencySet == true) Screen.Home.route else Screen.SelectCurrency.route
//
//    AnimatedNavHost(
